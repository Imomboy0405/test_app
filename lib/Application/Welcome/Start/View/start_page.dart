                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                            right: width * .06,
                            left: width * .06,
                            top: (MediaQuery.of(context).size.height - width * 1.6) > 0
                                ? (MediaQuery.of(context).size.height - (MediaQuery.of(context).size.height - width * 1.4))
                                : 0,
                          ),
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  AnimatedContainer(
                                    ...
                                    child: MaterialButton(
                                      ...
                                      height: width * .1,
                                      padding: EdgeInsets.only(left: width * .05, right: width * .09),
                                      child: Text(
                                        'skip'.tr(),
                              ...
                              SizedBox(
                                height: (MediaQuery.of(context).size.height - width * 1.6) > 0
                                  ? (MediaQuery.of(context).size.height - (MediaQuery.of(context).size.height - width * .1))
                                  : 0,
                              ),
                              // #text
                              RichText(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () => context.read<StartBloc>().add(TermsEvent(policy: true)),
                                    ),
                                  ],
                                ),
                              ),
